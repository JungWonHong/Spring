...
<html>
	<head>
		...
		<script>
		/*
		 - $.get() 메서드는 get방식으로 서버와 통신하는 jQuery 메서드입니다.
		 	- $.get() 메서드는 서버의 welcome.jsp 페이지를 get방식으로 요청합니다.
		...
		*/
			...
			$(function(){
				$('form').submit(function(){
					...
					var data = $(this).serialize(); //username=홍길동, userage=27
					
					$.get(	//post 방식으로 자료를 전달합니다.
							"welcome3.jsp",  //문자열 형식의 파라미터를 welcome.jsp로 보냅니다.
							data,		//username="홍길동"; 형식으로 전송합니다.
