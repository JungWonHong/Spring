 ...
 * Generated at: 2017-08-11 05:57:51 UTC
...
public final class _2_005fqueryString_jsp extends org.apache.jasper.runtime.HttpJspBase
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t\tsendData = 'name=' + $('.username1').val();\r\n");
      out.write("\t\t\t\t\t\tsendData += \"&\" + \"age=\" + $('.userage1').val();\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t$.post(\t//post 방식으로 자료를 전달합니다.\r\n");
      out.write("\t\t\t\t\t\t\t\"welcome2.jsp\",  //문자열 형식의 파라미터를 welcome.jsp로 보냅니다.\r\n");
      ...
      out.write("\t\t\t<input type=\"text\" name=\"username\" class=\"username1\"><br>\r\n");
      out.write("\t\t\t<label>나이를 입력하세요 : </label>\r\n");
      out.write("\t\t\t<input type=\"text\" name=\"userage\" class=\"userage1\"><br>\r\n");
