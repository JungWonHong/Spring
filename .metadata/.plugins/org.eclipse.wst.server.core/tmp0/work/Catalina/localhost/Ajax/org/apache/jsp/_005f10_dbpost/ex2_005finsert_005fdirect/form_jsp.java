 ...
 * Generated at: 2017-08-14 04:12:28 UTC
...
return;
    ...
    try {
      ...
      out.write("\t\t\t\t\t$.getJSON('products.jsp', function(data){\r\n");
      ...
      out.write("\t\t\t\t\t}\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t//전송할 데이터틀을 직렬화 합니다.\r\n");
      out.write("\t\t\t\t\t//입력 양식에 입력한 데이터를 쿼리 스트링으로 바꿉니다.\r\n");
      out.write("\t\t\t\t\tvar data = $(this).serialize();\r\n");
      out.write("\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t//Ajax를 수행합니다.\r\n");
      out.write("\t\t\t\t\t$.getJSON('products.jsp', data, function(returndata){\r\n");
      out.write("\t\t\t\t\t\t$('#output').empty();\r\n");
      out.write("\t\t\t\t\t\t$(returndata).each(function(index, item){\r\n");
      out.write("\t\t\t\t\t\t\tvar output = '';\r\n");
      out.write("\t\t\t\t\t\t\toutput += '<tr>';\r\n");
