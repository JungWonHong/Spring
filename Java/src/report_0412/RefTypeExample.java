...
public class RefTypeExample {
	...
	public static void main(String[] args) {
		...
		Account obj3 = new CheckingAccount("111-22-33333333", "홍길동", 10, "4444-5555-6666-7777");
	...
	static void printAccountInfo(Account obj) {
		...
		if (obj instanceof CheckingAccount) {
			CheckingAccount obj1 = (CheckingAccount) obj; // 다운캐스팅
			System.out.println("카드번호: " + obj1.cardNo);
			// System.out.println("카드번호: " + ((CheckingAccount)obj).cardNo);
		}
