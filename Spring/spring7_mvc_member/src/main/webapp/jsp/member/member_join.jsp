   ...
   <table id="join_t">
    ...
    <tr>
     ...
     <td>
      ...
      -<input name="join_zip2" id="join_zip2" size="3" class="input_box" 
              readonly onclick="post_search()">
    ...
    <tr>
     ...
     <td>
      <%@ include file="/jsp/include/tel_number.jsp" %>
       ...
       -<input name="join_tel2" id="join_tel2" class="input_box" size="4" maxlength="4">
       -<input name="join_tel3" id="join_tel3" class="input_box" size="4" maxlength="4">
     </td>
    </tr>
    ...
    <tr>
     ...
     <td>
      <%@ include file="/jsp/include/phone_number.jsp" %>
       ...
       -<input name="join_phone2" id="join_phone2" class="input_box" size="4" maxlength="4">
       -<input name="join_phone3" id="join_phone3" class="input_box" size="4" maxlength="4">
     </td>
    </tr>
    ...
    <tr>
     ...
     <td>
      <input name="join_mailid" id="join_mailid" size="10" 
             class="input_box" >
      @<input name="join_maildomain" id="join_maildomain" 
              size="20" class="input_box" readonly >
