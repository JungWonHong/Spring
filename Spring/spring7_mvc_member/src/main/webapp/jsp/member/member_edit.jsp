  ...
  <form name="f" method="post" action="member_edit_ok.nhn"
   ...
   <table id="join_t">
    ...
    <tr>
     <th>회원비번</th>
     <td>
      <input type="password" name="join_pwd" id="join_pwd1" 
    ...
    <tr>
     ...
     <td>
      <input name="join_name"    id="join_name" size="14" 
             class="input_box"   value="${editm.join_name}" />
     </td>
    </tr>
    ...
    <tr>
     <th>우편번호</th>
     <td>
      <input name="join_zip1" id="join_zip1" size="3" 
             class="input_box"   readonly 
             onclick="post_search()"  value="${editm.join_zip1}"/>
      -<input name="join_zip2" id="join_zip2" size="3" 
              class="input_box" readonly 
    ...
    <tr>
     <th>주소2</th>
     <td>
      <input name="join_addr1" id="join_addr1" size="50" 
             class="input_box" readonly 
             value="${editm.join_addr1}" onclick="post_search()" />
     </td>
    </tr>
    ...
    <tr>
     ...
     <td>
      ...
      <%@ include file="../../jsp/include/domain_list.jsp" %>
