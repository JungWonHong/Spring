	...
	public ActionForward execute(HttpServletRequest request, 
		...
		/*
			startpage : 현재 페이지 그룹에서 맨 처음에 표시될 페이지 수를 의미합니다.
						([1], [11], [21] 등 ...)
			보여줄 페이지가 30개일 경우 [1][2][3]....[30]까지 다 표시되기 너무 많기 때문에
		...
		forward.setPath("./ch14/_1.Model2/board/qna_board_list.jsp");
