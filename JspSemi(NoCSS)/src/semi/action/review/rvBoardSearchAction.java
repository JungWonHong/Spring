...
public class rvBoardSearchAction implements Action {
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		int listcount=boarddao.rvSearchListCount(keyField, keyWord); //총 리스트 수를 받아옴
		boardlist=boarddao.rvSearchBoardList(keyField, keyWord, page, limit); //페이지와 리스트에 표시할 글 수를 파라미터로 전달하여 글 목록을 얻어와서
